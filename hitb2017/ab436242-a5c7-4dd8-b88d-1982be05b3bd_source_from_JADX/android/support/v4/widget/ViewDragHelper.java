...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01391();
    ...
    private final Runnable mSetIdleRunnable = new C01402();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C01391 implements Interpolator {
        C01391() {
        }
