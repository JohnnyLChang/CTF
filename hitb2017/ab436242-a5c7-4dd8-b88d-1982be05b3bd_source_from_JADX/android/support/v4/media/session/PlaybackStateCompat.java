...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00941();
    ...
    static class C00941 implements Creator<PlaybackStateCompat> {
        C00941() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00951();
        ...
        static class C00951 implements Creator<CustomAction> {
            C00951() {
            }
