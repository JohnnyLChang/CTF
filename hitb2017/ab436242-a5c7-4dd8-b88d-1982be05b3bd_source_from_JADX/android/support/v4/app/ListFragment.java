...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00382();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00371();
    ...
    class C00382 implements OnItemClickListener {
        C00382() {
        }
