...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02521();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02532();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02373();

    class C02373 implements ViewPropertyAnimatorUpdateListener {
        C02373() {
        }
    ...
    class C02532 extends ViewPropertyAnimatorListenerAdapter {
        C02532() {
        }
