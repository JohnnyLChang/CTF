...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0156R.attr.actionBarSize, 16842841};
    ...
    class C01631 extends AnimatorListenerAdapter {
        C01631() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01631();
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0156R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0156R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0156R.id.action_bar));
        }
    }
