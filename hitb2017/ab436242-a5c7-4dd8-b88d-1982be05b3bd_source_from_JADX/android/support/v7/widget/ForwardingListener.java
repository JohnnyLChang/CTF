...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01741 implements OnAttachStateChangeListener {
        C01741() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01741());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01752());
    }
