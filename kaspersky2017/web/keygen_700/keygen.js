...
class BaseClass {
    constructor(param) {
        this.innerC1 = param.CoCoCo;
        this.innerC2 = param.CoCoCoCoCo();
        this.innerC3 = param.CoCoCoCoCo();
        this.innerC4 = param.CoCoCoCoCo();
    }
    ...
    CoCoCoCoCoCoCoCo() {
        switch (this.innerC3) {
            case 1:
                return this.innerC1.getUint8(this.innerC2) * this.innerC4;
            case 2:
                return this.innerC1.getUint16(this.innerC2) * this.innerC4;
            case 4:
                return this.innerC1.getUint32(this.innerC2) * this.innerC4;
        }
    }
    ...
    CoCoCoCoCoCoCoCoCo(CoCoCoCoCoCoCoCoCoCo) {
        switch (this.innerC3) {
            case 1:
                this.innerC1.setUint8(this.innerC2, CoCoCoCoCoCoCoCoCoCo);
                break;
            case 2:
                this.innerC1.setUint16(this.innerC2, CoCoCoCoCoCoCoCoCoCo);
                break;
            case 4:
                this.innerC1.setUint32(this.innerC2, CoCoCoCoCoCoCoCoCoCo);
                break;
        }
        this.innerC4 = 1;
    }
...
class CoClass1 {
    constructor(param) {
        this.cb = param.CoCoCoCoCoCoCoCoCoCoCoCo();
    }
...
class CoClass2 {
    constructor(param) {
        ...
        var val = param.CoCoCoCoCo();

        while (val--) {
            this.status += param.CoCoCoCoCoCoCoCoCoCoCoCoCoCoCo().CoCoCoCoCoCoCoCo();
        }
...
class CoClass2Child extends CoClass2 {
...
class CoClass2Child2 extends CoClass2 {
...
class Processor {
    constructor(param) {
        this.CoCoCoCoCoCoCoCoCoCoCoCoCoCoCoCo = new DataView(param.buffer);
        this.retval = 0;
        this.CoCoCo = new DataView(new ArrayBuffer(32));
        var plen = param.length;
        this.CoCoCo.setInt32(16, plen);
    ...
    CoCoCoCoCoCoCoCoCoCoCoCo() {
        var CoCoCoCoCoCoCoCoCoCo = this.CoCoCoCoCoCoCoCoCoCoCoCoCoCoCoCo.getUint32(this.retval);
        this.retval += 4;
        return CoCoCoCoCoCoCoCoCoCo;
    }

    CoCoCoCoCo() {
        var ret = this.CoCoCoCoCoCoCoCoCoCoCoCoCoCoCoCo.getUint8(this.retval);
        this.retval++;
        return ret;
    }
    ...
    CoCoCoCoCoCoCoCoCoCoCoCoCoCoCo() {
        ...
        switch (val) {
            ...
            case 2:
                return new CoClass1(this);
            case 3:
                return new CoClass2Child(this);
            case 4:
                return new CoClass2Child2(this);
        }
        return null;
    }
    ...
    dosetval(param) {
        var val1 = this.CoCoCo.getInt32(16) - 4;
        this.CoCoCo.setInt32(16, val1);
        this.CoCoCoCoCoCoCoCoCoCoCoCoCoCoCoCo.setUint32(val1, param);
        return val1;
    }
...
function GetFlag(inputflag) {
    ...
    console.log(process.CoCoCo.getInt32(0))
    if (process.CoCoCo.getInt32(0) >= 0)
        return new tdecode.TextDecoder("utf-8").decode(chararray.subarray(val2, val2 + 37));

    return "Failed";
}


console.log(GetFlag('KLCTF{afdafdafdsafdsafdsafdsafdsafdsafdaaaaaa}'));