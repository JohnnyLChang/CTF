...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    class C01585 implements Runnable {
        ...
        class C03031 extends ViewPropertyAnimatorListenerAdapter {
            C03031() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C03031());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C02593 implements OnFitSystemWindowsListener {
        C02593() {
        }
    ...
    class C02604 implements OnAttachListener {
        C02604() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C03051 extends ViewPropertyAnimatorListenerAdapter {
            C03051() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C03051());
            }
    ...
    class C03046 extends ViewPropertyAnimatorListenerAdapter {
        C03046() {
        }
        ...
        if (a.hasValue(C0161R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C02582());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C02593());
                }
            ...
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0161R.id.action_bar_activity_content);
            ...
            contentView.setAttachListener(new C02604());
            return subDecor;
        }
        a.recycle();
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C03046());
                    } else {
