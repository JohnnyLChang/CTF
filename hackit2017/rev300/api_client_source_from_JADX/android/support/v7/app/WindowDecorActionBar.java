...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03061();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03072();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02633();

    class C02633 implements ViewPropertyAnimatorUpdateListener {
        C02633() {
        }
    ...
    class C03061 extends ViewPropertyAnimatorListenerAdapter {
        C03061() {
        }
    ...
    class C03072 extends ViewPropertyAnimatorListenerAdapter {
        C03072() {
        }
    ...
    private void init(View decor) {
        ...
        if (a.getBoolean(C0161R.styleable.ActionBar_hideOnContentScroll, false)) {
