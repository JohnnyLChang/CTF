...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0161R.string.abc_action_bar_up_description, C0161R.drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        this.mDefaultNavigationIcon = a.getDrawable(C0161R.styleable.ActionBar_homeAsUpIndicator);
        if (style) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C01971());
    }
