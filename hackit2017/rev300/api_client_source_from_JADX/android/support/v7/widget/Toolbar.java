...
public class Toolbar extends ViewGroup {
    ...
    class C02731 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C02731() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02741());
        int expandedMenuItemId;
        boolean isOverflowOpen;

        static class C02741 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02741() {
            }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C02731();
        this.mShowOverflowMenuRunnable = new C01952();
        ...
        this.mButtonGravity = a.getInteger(C0161R.styleable.Toolbar_buttonGravity, 48);
        int titleMargin = a.getDimensionPixelOffset(C0161R.styleable.Toolbar_titleMargin, 0);
        if (a.hasValue(C0161R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0161R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        int contentInsetStart = a.getDimensionPixelOffset(C0161R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int contentInsetEnd = a.getDimensionPixelOffset(C0161R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0161R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0161R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0161R.attr.toolbarNavigationButtonStyle);
            LayoutParams lp = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0161R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C01963());
        }
    }
