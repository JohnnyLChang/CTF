...
public class PopupMenu {
    ...
    class C01832 implements android.widget.PopupWindow.OnDismissListener {
        C01832() {
        }
    ...
    class C02701 implements Callback {
        C02701() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C02701());
        ...
        this.mPopup.setOnDismissListener(new C01832());
    }
