...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01791 implements OnAttachStateChangeListener {
        C01791() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01791());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01802());
    }
