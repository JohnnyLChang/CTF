...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01721 extends DataSetObserver {
        C01721() {
        }
    ...
    class C01732 implements OnGlobalLayoutListener {
        C01732() {
        }
    ...
    class C01744 extends DataSetObserver {
        C01744() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C01721();
        this.mOnGlobalLayoutListener = new C01732();
        ...
        this.mAdapter.registerDataSetObserver(new C01744());
