...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0161R.styleable.LinearLayoutCompat, defStyleAttr, 0);
        ...
        this.mWeightSum = a.getFloat(C0161R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        ...
        this.mShowDividers = a.getInt(C0161R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = a.getDimensionPixelSize(C0161R.styleable.LinearLayoutCompat_dividerPadding, 0);
        a.recycle();
    }
