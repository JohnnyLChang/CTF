...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01884 implements OnFocusChangeListener {
        C01884() {
        }
    ...
    class C01895 implements OnLayoutChangeListener {
        C01895() {
        }
    ...
    class C01917 implements OnClickListener {
        C01917() {
        }
    ...
    class C01928 implements OnKeyListener {
        C01928() {
        }
    ...
    class C01939 implements OnEditorActionListener {
        C01939() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01851();
        this.mUpdateDrawableStateRunnable = new C01862();
        this.mReleaseCursorRunnable = new C01873();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01917();
        this.mTextKeyListener = new C01928();
        this.mOnEditorActionListener = new C01939();
        ...
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0161R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0161R.styleable.SearchView_submitBackground));
        ...
        ViewCompat.setTooltipText(this.mSearchButton, getResources().getString(C0161R.string.abc_searchview_description_search));
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01884());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01895());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01906());
    }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0161R.dimen.abc_search_view_preferred_height);
    }
