...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00844();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C00855();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00833();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C00866();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C00811();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00822();

    class C00811 implements OnWindowAttachListener {
        C00811() {
        }
    ...
    class C00822 implements OnWindowFocusChangeListener {
        C00822() {
        }
    ...
    class C00833 extends BroadcastReceiver {
        C00833() {
        }
    ...
    class C00844 implements OnAudioFocusChangeListener {
        C00844() {
        }
    ...
    class C00855 implements OnGetPlaybackPositionListener {
        C00855() {
        }
    ...
    class C00866 implements OnPlaybackPositionUpdateListener {
        C00866() {
        }
