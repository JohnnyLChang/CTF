...
public class TransportMediator extends TransportController {
    ...
    class C00802 implements Callback {
        C00802() {
        }
    ...
    class C02361 implements TransportMediatorCallback {
        C02361() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C02361();
        this.mKeyEventCallback = new C00802();
