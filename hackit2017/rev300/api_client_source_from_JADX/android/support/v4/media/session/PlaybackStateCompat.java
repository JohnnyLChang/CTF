...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00991();
    ...
    static class C00991 implements Creator<PlaybackStateCompat> {
        C00991() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01001();
        ...
        static class C01001 implements Creator<CustomAction> {
            C01001() {
            }
