...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C00951();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C00951 implements Creator<QueueItem> {
            C00951() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C00961();
        private ResultReceiver mResultReceiver;

        static class C00961 implements Creator<ResultReceiverWrapper> {
            C00961() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C00971();
        private final Object mInner;

        static class C00971 implements Creator<Token> {
            C00971() {
            }
    ...
    class C02381 extends Callback {
        C02381() {
        }
    }

    class C02392 extends Callback {
        C02392() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02401();
        ...
        class C02401 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02401() {
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C00931 implements OnPlaybackPositionUpdateListener {
            C00931() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C00931());
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C00941 implements OnMetadataUpdateListener {
            C00941() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C00941());
        }
