...
public final class DiskLruCache implements Closeable {
    ...
    private static final Sink NULL_SINK = new C02824();
    private static final String READ = "READ";
    private static final String REMOVE = "REMOVE";
    static final String VERSION_1 = "1";
    private final int appVersion;
    private final Runnable cleanupRunnable = new C02081();
    ...
    class C02093 implements Iterator<Snapshot> {
    ...
    public final class Editor {
        ...
        public Sink newSink(int index) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    c03151 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
    ...
    static class C02824 implements Sink {
        C02824() {
        }
