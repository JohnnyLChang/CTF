...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02311());
        boolean isOpen;

        static class C02311 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02311() {
            }
