...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02091();
        ...
        class C02091 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02091() {
            }
        ...
        class C02502 implements Callback {
            C02502() {
            }
