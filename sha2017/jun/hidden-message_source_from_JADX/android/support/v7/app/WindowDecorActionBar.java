...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02541();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02552();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02383();

    class C02383 implements ViewPropertyAnimatorUpdateListener {
        C02383() {
        }
    ...
    class C02552 extends ViewPropertyAnimatorListenerAdapter {
        C02552() {
        }
